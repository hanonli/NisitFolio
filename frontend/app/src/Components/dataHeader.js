			...
			.then((datas) => {
				...
				this.state.data.InterestedJob_id.forEach((ele, index) => {
					jobdata.push({
						...
						Job_SkillName1: this.state.data.Job_SkillName[index][0][0] ? this.state.data.Job_SkillName[index][0][0] : "none",
						Job_SkillName2: this.state.data.Job_SkillName[index][0][1] ? this.state.data.Job_SkillName[index][0][1] : "none",
						Job_SkillName3: this.state.data.Job_SkillName[index][0][2] ? this.state.data.Job_SkillName[index][0][2] : "none",
