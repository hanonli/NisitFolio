...
class Resume3_A extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        var pftDiv = '<div class="lb-container" id={id}>\
							<div class="pft-ibox">\
								<img class="pft-bg" src="assets/images/black.jpg" alt=""/>\
                                <img className="img-mywork-1" src={img} />\
                            </div>\
							<div id="hover-box">\
                            <img class="pft-overlay" src="assets/images/black.jpg" alt=""/>\
								<img class="img-mywork-select" src="{privacy}" alt=""/>\
								<img class="img-mywork-bin" src="assets/images/white_bin.png" data-bs-toggle="modal" data-bs-target="#staticBackdrop" alt=""/>\
								<img class="img-mywork-edit" src="assets/images/whiteedit.png" alt=""/>\
								<div class="pft-name">{name}</div>\
							    <div class="pft-date">{date}</div>\
							</div>\
						</div>'
        ...
        fetch("http://localhost:2000/portfolio/", {
            ...
            .then((datas) => {
                ...
                if (datas.length < 1) { //no port
                    ...
                    $('.img-mywork-edit').on('click', function (e) {
                        e.stopPropagation();
                    ...
                    $('.img-mywork-select').on('click', function (e) {
                    ...
                    $('.img-mywork-bin').on('click', function (e) {
                        e.stopPropagation();
                    });
