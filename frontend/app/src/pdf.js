		...
		fetch("http://localhost:2000/myresume/",{
			...
			.then((datas) => {
				...
				/*const inputs = [{
					...
					"ทักษะ 1":datas[0].interestedJob[0].Job_SkillName[0].toString(),
					"ทักษะ 2":datas[0].interestedJob[0].Job_SkillName[1].toString(),
					"ทักษะ 3":datas[0].interestedJob[0].Job_SkillName[2].toString(),
					"คะแนน 1":datas[0].interestedJob[0].Job_Score[0],
					"คะแนน 2":datas[0].interestedJob[0].Job_Score[1],
					"คะแนน 3":datas[0].interestedJob[0].Job_Score[2],
					"เกณฑ์ 1":cal1,
					"เกณฑ์ 2":cal2,
					"เกณฑ์ 3":cal3,
					...
					"ปีเกียร์ติบัตร 1 ":datas[0].certificates[0].CertYear,
					"ปีเกียร์ติบัตร 2":datas[0].certificates[1].CertYear,
					"ปีเกียร์ติบัตร 3":datas[0].certificates[2].CertYear,
					"ปีเกียร์ติบัตร 4":datas[0].certificates[3].CertYear,
